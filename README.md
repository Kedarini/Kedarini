...
**Tools & Platforms**: Git, Linux (Arch Linux/CLI), Networking concepts, GitHub Actions (CI/CD), Docker | AWS(Cloud) | Terraform (IaC)          
**Currently Learning Deeply:** AWS | Terraform     
